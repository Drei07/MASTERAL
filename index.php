...
<body>
      ...
      <div class="page-banner home-banner">
        <div class="row align-items-center flex-wrap-reverse h-100">
          <div class="col-md-6 py-5 wow fadeInLeft">
            <h1 class="mb-4">The only way to predict the future is to have power to shape the future.</h1>
            <p class="text-lg text-grey mb-5">Involves the use of data and statistical analysis to make predictions about future trends or developments.</p>
            <a href="#" class="btn btn-primary btn-split">Check Now <div class="fab"><span class="mai-play"></span></div></a>
          </div>
          <div class="col-md-6 py-5 wow zoomIn">
            <div class="img-fluid text-center">
              <img src="src/img/Data report.svg"  alt="">
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
              <img src="src/img/services/service-1.svg" alt="">
            </div>
            <div class="body">
        ...
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
              <img src="src/img/services/service-2.svg" alt="">
            </div>
            <div class="body">
        ...
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
              <img src="src/img/services/service-3.svg" alt="">
            </div>
            <div class="body">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 py-3 wow fadeInUp">
          ...
          <h2 class="title-section">Prognostix the number #1 Forecasting System</h2>
          <div class="divider"></div>

          <p>A tool used to predict future outcomes based on historical data and other relevant information. Our systems typically use statistical and mathematical techniques to analyze past data and make predictions about future events.</p>
          <a href="about" class="btn btn-primary mt-3">Read More</a>
        </div>
        <div class="col-lg-6 py-3 wow fadeInRight">
          <div class="img-fluid py-3 text-center">
            <img src="src/img/analytics.svg" alt="">
          </div>
        </div>
      </div>
    </div> <!-- .container -->
  ...
  <div class="page-section bg-light">
    <div class="container">
      <div class="text-center wow fadeInUp">
        ...
        <h2 class="title-section">How Prognostix Team Can Help</h2>
  ...
  <div class="page-section banner-info">
    <div class="wrap bg-image" style="background-image: url(src/img/bg_pattern.svg);">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 pr-lg-5 wow fadeInUp">
            <h2 class="title-section">Prognostix planning</h2>
            <div class="divider"></div>
            <p>We're an experienced and talented team of passionate consultants who breathe with search engine marketing.</p>
            
            <ul class="theme-list theme-list-light text-white">
              <li>
                <div class="h5">Prognostix Content Strategy</div>
                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor</p>
              </li>
              <li>
                <div class="h5">Prognostix Future Plan</div>
                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor</p>
              </li>
            </ul>
          </div>
          <div class="col-lg-6 py-3 wow fadeInRight">
            <div class="img-fluid text-center">
              <img src="src/img/analytics-2.svg" alt="">
            </div>
          </div>
        </div>
      </div>
